    ...
    <div class="container-data">
        ...
        <div class="container-data-list">
            ...
            <div class="order-item">
                <img src="<%=prodotto.getImmagine()%>" class="product-image">
                <div class="product-details">
                    <p style="font-size: 21px;font-weight: 450"><%=prodotto.getNome()%></p>
                    <p>Gusto: <%=gusto.getNomeGusto()%></p>
                    <p>Peso: <%=confezione.getPeso()%>g</p>
